  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-white text-black">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <h2 className="font-semibold text-lg text-left ml-5 mt-3">Hello I'm Odemy AI</h2>
        {/* Chat Messages */}
...
<div className="p-4 bg-white text-black rounded-xl shadow  space-y-4  mx-auto">
  ...
  <div className="flex items-center gap-3">
    ...
    <div className="bg-black/5 p-3 rounded-lg w-full">
  ...
  <div className="flex  gap-3">
    ...
    <div className="bg-black/5 p-3 rounded-lg w-full whitespace-pre-wrap text-sm leading-relaxed">
      {ans}
    </div>
    <div>
      <img src="/Odemy.png" alt="Bot" className="w-8 h-8 rounded-full object-cover border justify-start items-start" />
    </div>
  </div>
</div>
         }
